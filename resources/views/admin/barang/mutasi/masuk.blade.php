  ...
  <div class="container-fluid spark-screen">
    ...
    <div class="col-md-10 col-md-offset-1">
      ...
      <div class="box box-info">
        ...
        <br>
        <center>
          <h4>Mutasi Barang Keluar</h4></center>
          <br>
          <div class="box-body">

            <form method="POST" action=" {{url('barang/mutasi/keluar/save')}} ">
              {{ csrf_field() }}
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label">Jumlah yg ingin diMutasi</label>
                <div class="col-sm-3">
                  <div class="input-group text">
                    <div class="input-group-addon">
